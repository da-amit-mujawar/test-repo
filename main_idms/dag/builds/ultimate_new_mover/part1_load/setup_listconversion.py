...
# Lambda kicks off job when file appears (every Tuesday of the week at 8:00:00 PM EST).
dag = DAG('builds-ultimate-new-mover-part1-load',
          default_args=default_args,
          description='builds-ultimate-new-mover-part1-load',
