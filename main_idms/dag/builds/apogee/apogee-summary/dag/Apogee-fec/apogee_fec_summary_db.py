...
dag = DAG('builds-summary-calc-Apogee-FEC-DBLoad',
          default_args=default_args,
          description='Calculate Summary Information for Apogee FEC Data - Part 2 [DB Load]',
...
dwnld_sql_2_lcl = PythonOperator(task_id='Download_SQL_Files_from_s3',
...
addl_data_load = RedshiftOperator(task_id='Redshift_Load_CustomData',
                                  dag=dag,
...
start_process >> dwnld_sql_2_lcl >> data_load >> addl_data_load >> end_process
