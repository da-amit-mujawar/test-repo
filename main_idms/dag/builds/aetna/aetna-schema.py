...
def pipeline():
    ...
    def get_runtime_args(**kwargs):
        ...
        bucket_name = 'axle-customer-aetna'
    ...
    def email_callback(**kwargs):
        ...
        send_email(
            to=[
                "triyanshi.gupta@data-axle.com"
            ],
            subject=f"Airflow {env} Notification: aetna files {temp_tablename} processing",            
            html_content=f"""Hi, <br><br> Successfully process {temp_tablename} file and  DAG has been executed successfully""",
        )
