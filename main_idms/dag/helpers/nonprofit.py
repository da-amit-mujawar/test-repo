...
def get_config(databaseid, item):
    ...
    if env == "dev":
        config = {
            74: {
                "s3-silver-bucket": "develop_idms-2722-apogee",
                "s3-silver-folder": "/exports/transactions/",
                "s3-etl-bucket": "develop_idms-2722-apogee",
                "s3-etl-folder": "etl/build-output/",
                "consumer-listid": 21318,
                "s3-temp-bucket": "develop_idms-2722-playground",
        ...
        config = {
            74: {
                "s3-silver-bucket": "develop_idms-7933-apogee",
                "s3-silver-folder": "/exports/transactions/",
                "s3-etl-bucket": "develop_idms-7933-prod",
                "s3-etl-folder": "etl/apogee/build-output/",
                "consumer-listid": 21318,
                "s3-temp-bucket": "develop_idms-7933-temp",
                "child_table_name": "tblChild3"
            },
            1438: {
                "s3-silver-bucket": "axle-donorbase-silver-sources",
