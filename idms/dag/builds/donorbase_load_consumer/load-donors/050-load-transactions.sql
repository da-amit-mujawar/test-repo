DROP TABLE IF EXISTS DonorBase_Transactions;

CREATE TABLE DonorBase_Transactions
(
TableID bigint ENCODE ZSTD,
SourceListID int ENCODE ZSTD,
Individual_ID varchar(25) DISTKEY SORTKEY ENCODE RAW,
HouseHold_ID varchar(25) ENCODE ZSTD,
...
ALTER TABLE DonorBase_Transactions RENAME TO tblChild1_{build_id}_{build};
