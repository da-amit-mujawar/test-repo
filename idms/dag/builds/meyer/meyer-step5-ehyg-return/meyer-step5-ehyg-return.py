...
dag = DAG('builds-meyer-step5-ehyg-return',
          default_args=default_args,
          description='apply meyer email hygiene return file',
          tags=['prod'],
...
start_operator >> fetch_buildinfo >> data_load >> data_check >> send_notification >> end_operator