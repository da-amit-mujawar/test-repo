...
dag = DAG(
    "builds-donorbase-rollup-emr-load",
    default_args=default_args,
    description="Calculate Summary Information for DonorBase Data - EMR Processing",
...
fetch_build = PythonOperator(
    task_id="Fetch-DB-Build-Info",
