...
from helpers.apogee import get_donor_list_of_lists
...
dag = DAG('builds-summary-calc-apogee-All',
          default_args=default_args,
          description='Calculate Summary Information for Apogee Data - EMR and DBProcessing',
...
begin_prcs >> set_emr_prcsdate >> csv_to_parq >> prepare_data >> list_process >> custom_process >> dwnld_sql >> data_load >> addl_load >> end_prcs
