...
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_1 FROM SegmentCodes_1293
  WHERE cvalue = '1' GROUP BY AbiNumber
) SEGMENTCODE_1
ON SEGMENTCODE_1.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_2 FROM SegmentCodes_1293
  WHERE cvalue = '2' GROUP BY AbiNumber
) SEGMENTCODE_2
ON SEGMENTCODE_2.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_3 FROM SegmentCodes_1293
  WHERE cvalue = '3' GROUP BY AbiNumber
) SEGMENTCODE_3
ON SEGMENTCODE_3.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_4 FROM SegmentCodes_1293
  WHERE cvalue = '4' GROUP BY AbiNumber
) SEGMENTCODE_4
ON SEGMENTCODE_4.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_5 FROM SegmentCodes_1293
  WHERE cvalue = '5' GROUP BY AbiNumber
) SEGMENTCODE_5
ON SEGMENTCODE_5.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_6 FROM SegmentCodes_1293
  WHERE cvalue = '6' GROUP BY AbiNumber
) SEGMENTCODE_6
ON SEGMENTCODE_6.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_7 FROM SegmentCodes_1293
  WHERE cvalue = '7' GROUP BY AbiNumber
) SEGMENTCODE_7
ON SEGMENTCODE_7.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_8 FROM SegmentCodes_1293
  WHERE cvalue = '8' GROUP BY AbiNumber
) SEGMENTCODE_8
ON SEGMENTCODE_8.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_9 FROM SegmentCodes_1293
  WHERE cvalue = '9' GROUP BY AbiNumber
) SEGMENTCODE_9
ON SEGMENTCODE_9.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_A FROM SegmentCodes_1293
  WHERE cvalue = 'A' GROUP BY AbiNumber
) SEGMENTCODE_A
ON SEGMENTCODE_A.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_F FROM SegmentCodes_1293
  WHERE cvalue = 'F' GROUP BY AbiNumber
) SEGMENTCODE_F
ON SEGMENTCODE_F.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_H FROM SegmentCodes_1293
  WHERE cvalue = 'H' GROUP BY AbiNumber
) SEGMENTCODE_H
ON SEGMENTCODE_H.ABINumber = tblMain.AbiNumber
LEFT JOIN 
(
  SELECT AbiNumber AS AbiNumber,  MIN(cvalue) SEGMENTCODE_I FROM SegmentCodes_1293
