...
CREATE TABLE {maintable_name} (
    ...
    Zip_back character varying(5) ENCODE zstd,
...
district_description character varying(100) ENCODE lzo,
    credit_rating_description character varying(100) ENCODE zstd,
    title_description character varying(100) ENCODE lzo,
    gender_description character varying(100) ENCODE lzo,
    cma_description character varying(100) ENCODE lzo,
    regioncode_multi character varying(60) ENCODE zstd,
    regioncode_01 character varying(2) ENCODE zstd,
    regioncode_02 character varying(2) ENCODE zstd,
    regioncode_03 character varying(2) ENCODE zstd,
    regioncode_04 character varying(2) ENCODE zstd,
    regioncode_05 character varying(2) ENCODE zstd,
    regioncode_06 character varying(2) ENCODE zstd,
    regioncode_07 character varying(2) ENCODE zstd,
    regioncode_08 character varying(2) ENCODE zstd,
    regioncode_09 character varying(2) ENCODE zstd,
    regioncode_10 character varying(2) ENCODE zstd,
    regioncode_11 character varying(2) ENCODE zstd,
    regioncode_12 character varying(2) ENCODE zstd,
    regioncode_13 character varying(2) ENCODE zstd,
    regioncode_14 character varying(2) ENCODE zstd,
    regioncode_15 character varying(2) ENCODE zstd,
    postalcode_mailing character varying(9) ENCODE zstd,
    postalcode_landmark character varying(9) ENCODE zstd,
...
COPY {maintable_name}
FROM 's3://idms-7933-prod/temp/business-csv/CA_full'
IAM_ROLE '{iam}'
CSV
GZIP
TRIMBLANKS
