...
dag = DAG('builds-auto-db',
          default_args=default_args,
          description='builds-auto-db',
...
get_count = PythonOperator(
    ...
    op_kwargs={'tablename': Variable.get('var-db-1025', deserialize_json=True)['maintable_name']},
    provide_context=True,
    dag=dag)
...
sql_command = """ EXEC Common.dbo.usp_QCBuildReport @DatabaseID = 1025, @ChangePercentage  = 5 """
...
start_operator >> fetch_buildinfo >> data_load >> data_check >> rename_report >> get_count >> build_activate >> Fill_rate_QC_report >> send_notification >> end_operator