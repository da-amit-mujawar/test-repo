...
def pipeline():
    ...
    def send_notification():
        ...
        send_email_without_config(
            ...
            email_message="Hello Team,<br/><br/> The NonProfit Build is complete and staged for activation. </br></br>If you have any questions regarding this build, please open a new support ticket.</br></br></br>Thank you.</br></br>- IDMS Support Team</br>help-idms@data-axle.com",
            dag=dag)
