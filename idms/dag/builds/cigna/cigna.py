...
get_count = PythonOperator(
    ...
    op_kwargs={'tablename': Variable.get('var-db-1119', deserialize_json=True)['maintable_name']},
    provide_context=True,
    dag=dag)
...
sql_command = """ EXEC Common.dbo.usp_QCBuildReport @DatabaseID = 1119, @ChangePercentage  = 5 """
