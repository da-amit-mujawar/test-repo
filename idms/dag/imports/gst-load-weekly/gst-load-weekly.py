...
# Schedule to run weekly. Sample:  Run every Wednesday 5 am est

dag = DAG('imports-gst-load-weekly',
          default_args=default_args,
          description='imports gst load weekly',
