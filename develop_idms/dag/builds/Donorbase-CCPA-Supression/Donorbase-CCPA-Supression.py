...
@dag(
    ...
    dag_id="donorbase-ccpa-suppressions",
    description="NonProfit CCPA Daily Suppressions - Donorbase",
...
def pipeline():
    ...
    def send_notification():
        send_email_without_config(reportname= "/Reports/CCPA_Count_record_donorbase",
        dag = dag,
        email_business_users=["idmsadminconsumerpearl@data-axle.com"],
        email_subject=  "Nonprofit Daily CCPA Suppressions - DonorBase",
