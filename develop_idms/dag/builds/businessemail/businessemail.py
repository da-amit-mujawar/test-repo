...
get_count = PythonOperator(
    ...
    op_kwargs={'tablename': Variable.get('var-db-846', deserialize_json=True)['maintable_name']},
    provide_context=True,
    dag=dag)
...
sql_command = """ EXEC Common.dbo.usp_QCBuildReport @DatabaseID = 846, @ChangePercentage  = 5 """
...
start_operator >> fetch_buildinfo >> data_load >> data_check >> get_count >> build_activate >> Fill_rate_QC_report >> send_notification >> end_operator