...
def pipeline():
    ...
    def send_notification():
        ...
        report_list= [f"s3://develop_idms-7933-internalfiles/Reports/DataAxle_Auto_MMDB_Profile_{time_stamp}_Infutor.xlsx",
                    f"s3://develop_idms-7933-internalfiles/BuildAuditReports/InfogroupConsumer_1267_Sample000",
                    f"s3://develop_idms-7933-internalfiles/Reports/AuditReport_AutoLinkTable000",
                    f"s3://develop_idms-7933-internalfiles/Reports/auto_IDMS_extract000"],
    ...
    def write_excel():
        ...
        s3.Bucket('develop_idms-7933-internalfiles').put_object(Key=key_name, Body=data)
