...
def cluster_resume():
    REDSHIFT_CLUSTER_ID = "da-develop_idms-etl-01"
    try:
...
data_load3 = RedshiftOperator(
    task_id="load-business-email-data",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/010-3-*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
parallel_task1 = [data_load1, data_load2, data_load3, data_load4]

delete_canadian_records = RedshiftOperator(
    task_id="delete-canadian-records",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/011-delete-canadian-records.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load6 = RedshiftOperator(
    task_id="update-2-businessindividual",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/013*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load7 = RedshiftOperator(
    task_id="perform-3-insert-individual",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/014*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load8 = RedshiftOperator(
    ...
    dag=dag,
    sql_file_path=default_args["current_path"] + "/015-1*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load9 = RedshiftOperator(
    ...
    dag=dag,
    sql_file_path=default_args["current_path"] + "/015-2*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load11 = RedshiftOperator(
    ...
    dag=dag,
    sql_file_path=default_args["current_path"] + "/015-4*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load14 = RedshiftOperator(
    ...
    dag=dag,
    sql_file_path=default_args["current_path"] + "/016*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)
...
data_load15 = RedshiftOperator(
    ...
    dag=dag,
    sql_file_path=default_args["current_path"] + "/017*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)

data_load16 = RedshiftOperator(
    task_id="ctas1-update-export-maintable",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/018*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
    redshift_conn_id=redshift_etl_connection,
)

data_load17 = RedshiftOperator(
    task_id="create-maintable-view",
    dag=dag,
    sql_file_path=default_args["current_path"] + "/019*.sql",
    config_file_path=default_args["current_path"] + "/config.json",
...
get_count = PythonOperator(
    ...
    op_kwargs={
        "tablename": Variable.get("var-db-992", deserialize_json=True)["maintable_name"]
    },
    provide_context=True,
    dag=dag,
)
