...
def activate_build(report_path):
    ...
    with closing(sql_conn.cursor()) as sql_cursor:
        ...
        DROP TABLE IF EXISTS ##InfoGroupBusiness_NewBusinessWeekly_ToBeDropped;
        CREATE TABLE ##InfoGroupBusiness_NewBusinessWeekly_ToBeDropped (BUILDID int, Databaseid int, cDescription varchar(70), iRecordCount int);

        INSERT INTO ##InfoGroupBusiness_NewBusinessWeekly_ToBeDropped (BUILDID, Databaseid, cDescription, iRecordCount)
        ...
        Select @nCount = count(*) from ##InfoGroupBusiness_NewBusinessWeekly_ToBeDropped
        ...
        FROM ##InfoGroupBusiness_NewBusinessWeekly_ToBeDropped  A
