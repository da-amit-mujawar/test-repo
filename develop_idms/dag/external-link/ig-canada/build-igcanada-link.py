...
dag = DAG('external-link-ig-canada',
          default_args=default_args,
          description='builds-IGCanada-link',
...
get_count = PythonOperator(
    ...
    op_kwargs={"tablename":"tblexternal14_191_201206"},
...
start_operator >> data_load >> get_count >> Prevent_sample_load >> send_notification >> end_operator
