...
@dag(
    ...
    dag_id="imports-park-multicoding-extract",
    description="Park Multicoding Extract",
...
def pipeline():
    ...
    send_notification = EmailOperator(
        ...
        subject="Park Multicoding Extract Completed",
        html_content="The dag has been completed",
    )
