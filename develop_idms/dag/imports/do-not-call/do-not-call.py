...
# weekdays (file updated 11a ET, data-synch 3p ET, dag 11p GST (7p/6p EST/EDT)
dag = DAG('imports-do-not-call',
    default_args=default_args,
    description='imports do-not-call',
...
data_load = RedshiftOperator(
    task_id='loading-import-file-do-not-call',
    dag=dag,
