...
#change to daily 1 am
dag = DAG('imports-global-email-suppressions',
          default_args=default_args,
          description='imports global email suppression lookup',
...
data_load = RedshiftOperator(
    task_id='loading-global-email-suppressions',
    dag=dag,
