...
Move /Y %BCP_EXPORT_DB%_%BCP_EXPORT_TABLE%.gz %BCP_EXPORT_PATH%
aws s3 cp E:\Redshift_DataIngestion\MyInfo\%BCP_EXPORT_DB%_%BCP_EXPORT_TABLE%.gz s3://axle-internal-sources/raw/myinfo/%BCP_EXPORT_DB%_%BCP_EXPORT_TABLE%/
