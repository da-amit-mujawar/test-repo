...
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ar_collectors;

CREATE VIEW interna.ebsprod_ar_collectors
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_gl_accts_desc_table;

CREATE VIEW interna.ebsprod_gl_accts_desc_table
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_gl_code_combinations;

CREATE VIEW interna.ebsprod_gl_code_combinations
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_mtl_system_items_b;

CREATE VIEW interna.ebsprod_mtl_system_items_b
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_cust_trx_line_gl_dist_all;

CREATE VIEW interna.ebsprod_ra_cust_trx_line_gl_dist_all
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_cust_trx_line_salesreps_all;

CREATE VIEW interna.ebsprod_ra_cust_trx_line_salesreps_all
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_cust_trx_types_all;

CREATE VIEW interna.ebsprod_ra_cust_trx_types_all
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_customer_trx_all;

CREATE VIEW interna.ebsprod_ra_customer_trx_all
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_customer_trx_lines_all;

CREATE VIEW interna.ebsprod_ra_customer_trx_lines_all
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_customers;

CREATE VIEW interna.ebsprod_ra_customers
AS
SELECT *
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_ra_salesreps_all;

CREATE VIEW interna.ebsprod_ra_salesreps_all
AS
SELECT *
  FROM spectrumdb.ebsprod_apps_ra_salesreps_all
  WITH NO SCHEMA BINDING;

DROP TABLE IF EXISTS spectrumdb.ebsprod_apps_ra_addresses_all;
...
DROP VIEW IF EXISTS interna.ebsprod_ra_addresses_all;

CREATE VIEW interna.ebsprod_ra_addresses_all
AS
SELECT *
...
DROP VIEW IF EXISTS interna.ebsprod_ra_site_uses_all;

CREATE VIEW interna.ebsprod_ra_site_uses_all
AS
SELECT *
  FROM spectrumdb.ebsprod_apps_ra_site_uses_all
  WITH NO SCHEMA BINDING;

DROP TABLE IF EXISTS spectrumdb.ebsprod_datalake_gaap_detail;

CREATE EXTERNAL TABLE spectrumdb.ebsprod_datalake_gaap_detail (CUSTOMER_TRX_ID BIGINT,
CUSTOMER_TRX_LINE_ID BIGINT,
CUSTOMER_NUMBER VARCHAR(120),
CUSTOMER_NAME VARCHAR(200),
SALESREP_NUMBER VARCHAR(120),
SALESREP_NAME VARCHAR(1440),
...
SEGMENT5 VARCHAR(100),
SEGMENT5_DESC VARCHAR(960),
PROD_DESC VARCHAR(960),
INVENTORY_ITEM_ID INTEGER,
AS400_PRODUCT_CODE VARCHAR(600),
REVENUE_PCT_SPLIT DOUBLE PRECISION,
LINE_SALESREPID BIGINT,
PRODUCT_SEGMENT1 VARCHAR(160),
PRODUCT_SEGMENT2 VARCHAR(160),
PRODUCT_SEGMENT3 VARCHAR(160),
ORDER_DATE DATE,
QUANTITY_ORDERED DOUBLE PRECISION,
REVENUE_AMOUNT DOUBLE PRECISION,
LINE_TYPE VARCHAR(80),
LINE_AMOUNT DOUBLE PRECISION,
FREIGHT_AMOUNT DOUBLE PRECISION,
TAX_AMOUNT DOUBLE PRECISION,
GLDIST_AMOUNT DOUBLE PRECISION,
SALES_ORDER VARCHAR(200),
FUNC_REVENUE_AMOUNT DOUBLE PRECISION,
INVOICE_CURRENCY_CODE VARCHAR(60),
MEDIA_CODE VARCHAR(600),
SECONDARY_SALESREP_NAME VARCHAR(1440),
TERTIARY_SALESREP_NAME VARCHAR(1440),
CREATION_DATE DATE,
LAST_UPDATE_DATE DATE) ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde' WITH SERDEPROPERTIES (
'separatorChar' = '|',
'quoteChar' = '"',
'escapeChar' = '\\'
)
STORED AS textfile
LOCATION 's3://axle-internal-sources/raw/ebsprod/datalake_gaap_detail/'
;
-------------------------------------------
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.ebsprod_datalake_gaap_detail;

CREATE VIEW interna.ebsprod_datalake_gaap_detail
AS
SELECT *
  FROM spectrumdb.ebsprod_datalake_gaap_detail
  WITH NO SCHEMA BINDING;
