--DROP TABLE IF EXISTS spectrumdb.S143000_t001_client;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t001_client(
--	client_id smallint ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t001_client/';
...
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t001_client;
--
--CREATE VIEW interna.S143000_t001_client AS 
--SELECT * 
--  FROM spectrumdb.S143000_t001_client
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t001_client;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t001_client;
--  
------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t002_list;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t002_list(
--	list_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t002_list/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t002_list;
--
--CREATE VIEW interna.S143000_t002_list AS 
--SELECT * 
--  FROM spectrumdb.S143000_t002_list
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t002_list;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t002_list;
--  
------------
--
DROP TABLE IF EXISTS spectrumdb.S143000_t006_message;

CREATE EXTERNAL TABLE spectrumdb.S143000_t006_message(
	message_id  int ,
...
STORED AS textfile
LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t006_message/';
--TABLE PROPERTIES ('skip.header.line.count'='1');
--TABLE PROPERTIES ('compression_type'='gzip');
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.S143000_t006_message;

CREATE VIEW interna.S143000_t006_message AS 
SELECT * 
  FROM spectrumdb.S143000_t006_message
  WITH NO SCHEMA BINDING;
 

-- Verify Counts
SELECT COUNT(*) 
  FROM interna.S143000_t006_message;
...
-------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t015_segment;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t015_segment(
--	segment_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t015_segment/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t015_segment;
--
--CREATE VIEW interna.S143000_t015_segment AS 
--SELECT * 
--  FROM spectrumdb.S143000_t015_segment
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t015_segment;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t015_segment;
--  
-------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t032_email_message;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t032_email_message(
--	email_message_id int,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t032_email_message/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t032_email_message;
--
--CREATE VIEW interna.S143000_t032_email_message AS 
--SELECT * 
--  FROM spectrumdb.S143000_t032_email_message
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t032_email_message;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t032_email_message;
--  
----------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t035_hard_bounce;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t035_hard_bounce(
--	id int ,
--	message_id int ,
--	list_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t035_hard_bounce/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t035_hard_bounce;
--
--CREATE VIEW interna.S143000_t035_hard_bounce AS 
--SELECT * 
--  FROM spectrumdb.S143000_t035_hard_bounce
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t035_hard_bounce;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t035_hard_bounce;
--  
--------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t036_soft_bounce;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t036_soft_bounce(
--	message_id int ,
--	list_id int ,
--	subscriber_id_internal int ,
--	segment_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t036_soft_bounce/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t036_soft_bounce;
--
--CREATE VIEW interna.S143000_t036_soft_bounce AS 
--SELECT * 
--  FROM spectrumdb.S143000_t036_soft_bounce
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t036_soft_bounce;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t036_soft_bounce;
--  
---------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t037_undeliverable;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t037_undeliverable(
--	message_id int ,
--	list_id int ,
--	brand_id int ,
--	subscriber_id_internal int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t037_undeliverable/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t037_undeliverable;
--
--CREATE VIEW interna.S143000_t037_undeliverable AS 
--SELECT * 
--  FROM spectrumdb.S143000_t037_undeliverable
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t037_undeliverable;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t037_undeliverable;
--  
-----------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t044_trackable_url;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t044_trackable_url(
--	url_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t044_trackable_url/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t044_trackable_url;
--
--CREATE VIEW interna.S143000_t044_trackable_url AS 
--SELECT * 
--  FROM spectrumdb.S143000_t044_trackable_url
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t044_trackable_url;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t044_trackable_url;
--  
---------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t050_message_candidate;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t050_message_candidate(
--	id int ,
--	message_id int ,
--	segment_id int ,
--	list_id int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t050_message_candidate/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t050_message_candidate;
--
--CREATE VIEW interna.S143000_t050_message_candidate AS 
--SELECT * 
--  FROM spectrumdb.S143000_t050_message_candidate
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t050_message_candidate;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t050_message_candidate;
--
--------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t082_message_list_trackable_url_assoc;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t082_message_list_trackable_url_assoc(
--	message_id int ,
--	segment_id int ,
--	list_id int ,
--	subscriber_id_internal int ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t082_message_list_trackable_url_assoc/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t082_message_list_trackable_url_assoc;
--
--CREATE VIEW interna.S143000_t082_message_list_trackable_url_assoc AS 
--SELECT * 
--  FROM spectrumdb.S143000_t082_message_list_trackable_url_assoc
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t082_message_list_trackable_url_assoc;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t082_message_list_trackable_url_assoc;
--  
------------
--
DROP TABLE IF EXISTS spectrumdb.S143000_t151_rpt_delivery_response_message_segment;

CREATE EXTERNAL TABLE spectrumdb.S143000_t151_rpt_delivery_response_message_segment(
	message_id int ,
	segment_id int ,
	domain_id int ,
	pushed int ,
...
STORED AS textfile
LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t151_rpt_delivery_response_message_segment/';
--TABLE PROPERTIES ('skip.header.line.count'='1');
--TABLE PROPERTIES ('compression_type'='gzip');
...
-- Create a view in interna schema
-------------------------------------------
DROP VIEW IF EXISTS interna.S143000_t151_rpt_delivery_response_message_segment;

CREATE VIEW interna.S143000_t151_rpt_delivery_response_message_segment AS 
SELECT * 
  FROM spectrumdb.S143000_t151_rpt_delivery_response_message_segment
  WITH NO SCHEMA BINDING;
 

-- Verify Counts
SELECT COUNT(*) 
  FROM interna.S143000_t151_rpt_delivery_response_message_segment;
...
---------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t203_division;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t203_division(
--	division_id smallint,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t203_division/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t203_division;
--
--CREATE VIEW interna.S143000_t203_division AS 
--SELECT * 
--  FROM spectrumdb.S143000_t203_division
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t203_division;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t203_division;
--  
------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t216_message_category;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t216_message_category(
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t216_message_category/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t216_message_category;
--
--CREATE VIEW interna.S143000_t216_message_category AS 
--SELECT * 
--  FROM spectrumdb.S143000_t216_message_category
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t216_message_category;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t216_message_category;
--
-------------
--
-- DROP TABLE IF EXISTS spectrumdb.S143000_t217_message_rate_type;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t217_message_rate_type(
--	rate_type_id smallint ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t217_message_rate_type/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t217_message_rate_type;
--
--CREATE VIEW interna.S143000_t217_message_rate_type AS 
--SELECT * 
--  FROM spectrumdb.S143000_t217_message_rate_type
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t217_message_rate_type;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t217_message_rate_type;
--  
-------------
--
--DROP TABLE IF EXISTS spectrumdb.S143000_t218_business_unit;
--
--CREATE EXTERNAL TABLE spectrumdb.S143000_t218_business_unit(
--	business_unit_id smallint ,
...
--   )
--STORED AS textfile
--LOCATION 's3://axle-internal-sources/raw/daddy/S143000_t218_business_unit/';
----TABLE PROPERTIES ('skip.header.line.count'='1');
----TABLE PROPERTIES ('compression_type'='gzip');
-- 
---------------------------------------------
---- Create a view in interna schema
---------------------------------------------
--DROP VIEW IF EXISTS interna.S143000_t218_business_unit;
--
--CREATE VIEW interna.S143000_t218_business_unit AS 
--SELECT * 
--  FROM spectrumdb.S143000_t218_business_unit
--  WITH NO SCHEMA BINDING;
-- 
--
---- Verify Counts
--SELECT COUNT(*) 
--  FROM interna.S143000_t218_business_unit;
--
--SELECT TOP 100 * 
--  FROM interna.S143000_t218_business_unit;
